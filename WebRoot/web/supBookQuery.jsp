...
<html>
  <head>
    ...
    <title>My JSP 'supManQuery.jsp' starting page</title>
  ...
  <body>
  <center>
    <form id="myForm" action="<c:url value='/BookServlet?method=supBookQuery'/>" method="get">
    	<input type="hidden" name="method" value="supBookQuery">
    	<p>
    		编号:
    	...
    	<p>
    		出版社编号:
			<input type="text" id="publishHouseId" name="publishHouseId">
    	</p>
    	
    	<p>
    		是否选择日期:
    		<input type="radio" name="modPic" value="yes" onchange="isSelectDate()">是
