...
<html>
  ...
  <body>
  <center>
    <form id="myForm" action="<c:url value='/updateData?method=modifyHouseSecond'/>" method="post">
  		<p>
  			出版社编号:<input type="text" name="id" value="${requestScope.request_book.id }" disabled="disabled">
  		</p>
  		<p>
  			出版社名称:<input type="text" name="name" value="${requestScope.request_book.name }">
  		</p>
  		<p>
