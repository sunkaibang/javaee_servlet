...
<html>
  <head>
    ...
    <title>My JSP 'addPublish.jsp' starting page</title>
	...
	<script type="text/javascript">
		...
		function checkId(idNode,infoNode){
			...
			xmlHttp.open("POST","<c:url value='/BServlet?method=ajaxPublish'/>",true);
  ...
  <body>
  <center>
  <form id="myForm" action="<c:url value='/BServlet?method=addPublish'/>" method="post">
  		<p>
  			出版社编号:<input type="text" id="id" name="id"><span id="info"></span>
  		</p>
  		<p>
